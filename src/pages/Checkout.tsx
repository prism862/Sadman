  ...
  if (cart.length === 0) {
    return (
      <div className="py-40 text-center">
        <h2 className="text-2xl font-display font-bold uppercase mb-4">Your bag is empty</h2>
        <Link to="/shop" className="prism-text font-bold uppercase tracking-widest text-sm">Return to Shop</Link>
      </div>
    );
  }
